...
export default function Chatbot({ text }) {
  const [messages, setMessages] = useState([
    { from: "bot", text: "Metin ile ilgili sorularınızı sorabilirsiniz." },
  ]);
    ...
    <div className="flex flex-col h-80 max-h-96">
      ...
      <form onSubmit={handleSend} className="flex gap-2 mt-2">
        <input
          ...
          placeholder="Metin ile ilgili sorunuzu yazın..."
        ...
        <button
          ...
          disabled={loading || !input.trim() || !text}
        >
          Gönder
        </button>
      </form>
